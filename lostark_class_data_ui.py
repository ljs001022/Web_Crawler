...
################################################################################
## Form generated from reading UI file 'lostark_class_data.ui'
##
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.verticalLayoutWidget_2.setGeometry(QRect(30, 20, 831, 791))
...
"background-color: rgb(12, 12, 12);")
        ...
        self.date = QDateEdit(self.verticalLayoutWidget_2)
        self.date.setObjectName(u"date")
        self.date.setDate(QDate(2024, 10, 23))

        self.formLayout.setWidget(1, QFormLayout.FieldRole, self.date)
    ...
    def retranslateUi(self, Form):
        ...
        self.label_3.setText(QCoreApplication.translate("Form", u"\ub0a0\uc9dc", None))
